...
describe('发布模块入口文件测试', () => {
  ...
  describe('导出内容类型验证', () => {
    test('resolveBin 应该是从 resolve-bin 库导出的函数', () => {
  ...
  describe('模块完整性验证', () => {
    ...
    test('Runner 类应该是可实例化的', () => {
      expect(typeof releaseIndex.Runner).toBe('function')
      expect(() => new releaseIndex.Runner()).not.toThrow()
    })

    test('AppError 类应该是可实例化的错误类', () => {
