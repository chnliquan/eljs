 ...
 * @param file 文件路径
 */
export function readJSON(_x) {
  return _readJSON.apply(this, arguments);
}
function _readJSON() {
  _readJSON = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(file) {
    var content;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          return _context.abrupt("return", parseJSON(content));
        case 7:
          _context.prev = 7;
